...
from smartmemorizer.app import create_app
from smartmemorizer.database import db
from smartmemorizer.settings import DevConfig, ProdConfig
from smartmemorizer.user.models import User

CONFIG = ProdConfig if os.environ.get('SMARTMEMORIZER_ENV') == 'prod' else DevConfig
